  ...
  return (
    <>
      <header className="top-0 left-0 w-full z-50 shadow-md">
        ...
        <div className="flex gap-16 text-[var(--color-starDust)] text-sm md:text-lg font-metamorphous">
            <a href="/" 
              className="hover:drop-shadow-[0_0_8px_#FFDBB7] hover:scale-110 transition-all duration-300" >
            INICIO
            </a>
            <a href="/Favorites" 
              className="hover:drop-shadow-[0_0_8px_#FFDBB7] hover:scale-110 transition-all duration-300"  >
